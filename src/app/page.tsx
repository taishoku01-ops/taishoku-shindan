        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-[2rem] px-3 py-3 sm:p-10 text-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100">
          ...
          <div>
            ...
            <h1 className="font-extrabold leading-tight mb-1 sm:mb-3 text-slate-800 tracking-tight">
              <span className="text-base sm:text-xl text-slate-500 font-bold block mb-0.5">
                仕事がつらい、もう限界かも…
              </span>
            ...
            <p className="text-xs sm:text-base text-slate-500 mb-2 sm:mb-5 leading-relaxed">
              一人で抱え込まなくて大丈夫。<br />
              まずは気軽に相談してみませんか？
            </p>
          </div>
          ...
          <div className="w-full border-4 sm:border-[5px] border-yellow-400 bg-gradient-to-b from-yellow-50 to-yellow-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 mb-3 sm:mb-5 shadow-xl shadow-yellow-400/40 ring-2 sm:ring-4 ring-yellow-300/40 relative">
            ...
            <div className="space-y-2 sm:space-y-4 relative">
              <div className="bg-white rounded-lg sm:rounded-xl p-2.5 sm:p-4 border-2 border-yellow-300">
                ...
                <p className="text-slate-700 text-sm sm:text-base font-bold mt-0.5">
                  → 「ブラウザで開く」を選択
                </p>
              </div>
          ...
          <a
              ...
              className="block w-full bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 active:from-green-700 active:to-emerald-700 text-white font-extrabold text-lg sm:text-2xl py-3.5 sm:py-5 rounded-full text-center shadow-[0_10px_30px_-10px_rgba(34,197,94,0.6)] transition-all"
            >
              詳しくはこちら
            </a>
